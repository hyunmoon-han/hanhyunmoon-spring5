...
--------------------------------------------------------
 ...
 LOB ("CONTENT") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
   ...
   COMMENT ON COLUMN "XE"."TBL_BOARD"."BNO" IS '게시판고유번호(자동즐가처리)';
   ...
   COMMENT ON COLUMN "XE"."TBL_BOARD"."VIEW_COUN" IS '글조회수카운터';
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "XE"."TBL_MEMBER"."USER_NAME" IS '회이름';
...
is
  l_password varchar2(4000);
  l_salt varchar2(4000) := 'QHE1XL8R3L9YXXG3Q1SDT5X9P74QAQ';
begin
