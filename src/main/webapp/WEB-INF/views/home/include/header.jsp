		...
		<div class="header_area box_inner clear">
			...
			<div class="header_cont">
				...
				<ul class="gnb clear">
					...
					<li><a href="/home/board/board_list?board_type=notice&seadch_keyword=" class="openAll2">커뮤니티</a>
				        <div class="gnb_depth gnb_depth2_2">
                            <ul class="submenu_list">
                            <c:forEach var="boardTypeVO" items="${listBoardTypeVO}">
                                <li><a href="/home/board/board_list?board_type=${boardTypeVO.board_type}&seadch_keyword=">${boardTypeVO.board_name}</a></li>                                                       
                            </c:forEach>
                            </ul>
                        </div>
					</li>
