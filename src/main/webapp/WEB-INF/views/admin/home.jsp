  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-body p-0">
            ...
            <c:forEach var="memberVO" items="${latestMembers}">
              <li style="cursor: pointer;" onclick="location.replace('/admin/member/member_view?user_id=${memberVO.user_id}&page=1')">
                <!--  <img src="/resources/admin/dist/img/default-150x150.png" alt="User Image">아래 inerror은 엑박일떄 대신 보여줄 이미지를 지정
                onerror ="this.src='/resources/admin/dist/img/default-150x150.png'"
                -->
                
                <img style="width:130px;height:120px;" onerror ="this.src='/resources/admin/dist/img/default-150x150.png'"  src="/resources/profile/${memberVO.user_id}.png">
        ...
        <!-- include와 import의 차이점: include는 소스를 조립후 컴파일 ,import는 개별 파일을 컴파일후 조립 -->
