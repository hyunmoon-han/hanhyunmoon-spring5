				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input readonly type="text" value="${boardVO.writer}" name="writer" class="w100p" id="writer_lbl" placeholder="이름을 입력해주세요" required/></div>
						</li>
						<li class="clear">
		                ...
		                $(document).ready(function(){		                	
		                	$(".btn_file_delete").click(function(){
		                		//alert("zigzig");//화면이 바뀌지 않고 현재 선택한 파일만 삭제하는 경우
		                		...
		                		if(delete_file_name==""){//!=  테스트->ok되면 ==변경
		                			alert("선택한 파일이 없습니디.")
		                			return true;
		                			}//아래내용이 진행되지 않고 종료		                		
		                		$.ajax({
