...
public class PageVO {
	...
	private void calcPage() {
		...
		//2 1.9 1.8....1.2 1.1 =>2
		//ceil(11/10)*10=>20페이지==tempEnd 1-10펭지에서 11페이지값이 존재하면, 끝 페이지에 임시로 20이라
		//숫자를 줍니다.
	...
	public String getSeacch_type() {
		return seacch_type;
	}
	public void setSeacch_type(String seacch_type) {
		this.seacch_type = seacch_type;
	}
