    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card-tools">
              ...
              <div class="input-group input-group-md">
                <form name="form_search" action="/admin/board/board_list" method="GET" class="form-horizontal">
                  ...
                  <input type="text" value="${session_search_keyword}" name="search_keyword" class="form-control float-left" placeholder="검색어를 입력하세요." style="width: inherit;">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <c:forEach var="boardVO" items="${listBoardVO}"><!-- items배열값 -->
        ...
        <div class="col-12 text-right">
          <a href="/admin/board/board_insert-form" class="btn btn-primary mb-3">글쓰기</a>
          <ul class="pagination justify-content-center">  	
              ...
              <!--사용기준: 향상된for(주로사용-시스템부담이작아짐),일반for문(시작,끝 값이 정해진 로직에서 사용) -->
