        ...
        <div class="card card-primary">
          ...
          <form name="form_write" action="/admin/member/member_update" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
            	<img style="width:130px;height:120px;border-radius:70%;" onerror ="this.src='/resources/admin/dist/img/default-150x150.png'" src="/resources/profile/${memberVO.user_id}.png">
            </div>
              <!-- 사용자 프로필 이미지 등록 태그추가 -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input readonly value="${memberVO.user_id }" name="user_id" type="text" class="form-control" id="user_id" placeholder="회원 ID를 입력해 주세요" required>
              </div>
              <div class="form-group">
                <label for="user_pw">암호</label>
                <!-- 암호는 기존값이 필요없음.이유는 값이 있으면 업데이트진행,없으면, 업데이트에서 제외 -->
...
<script>
$(document).ready(function(){
	var form_update=$("form[name='form_write']");//아이디값이없는 폼 $("form[name='form_write']")
		...
		$("#btn_list").click(function(){
			/*폼을 get방식으로 전송시 암호와 같은 정보가 URL쿼리 스트링에 노출되어서주석처리 
