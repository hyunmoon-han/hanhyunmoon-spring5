          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
             ...
             <c:forEach var="boardTypeVO" items="${listBoardTypeVO}">
              <li class="nav-item">
                <a href="/admin/board/board_list?board_type=${boardTypeVO.board_type}&search_keyword=" class="nav-link ${boardTypeVO.board_type==session_board_type?'active':''}" > <!-- 다중게시판으로쓸board_type 초기값이여기서옴  -->
