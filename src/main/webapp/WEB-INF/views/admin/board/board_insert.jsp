          ...
          <form name="form_write" method="post" action="/admin/board/board_insert" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group" style="display:none">
                ...
                <!-- 세션값을 비교값으로 사용하는 이유는 신규 등록이기 때문에 기존 게시물정보가없습니다. -->
              ...
              <div class="form-group">
                ...
                <!--div_file_delete영역이름은  첨부파일을 개별 Ajax 삭제할때 필요  -->
                  <div class="custom-file">
                    <input name="file" type="file" class="custom-file-input" id="file_${idx}"><!-- 태그에서 id는 식별자  0 ,1,2,3...  아래for과id는 한쌍-->
...
<script>
	$(document).ready(function(){
		...
		//서머노트에서 html5의 required 속성이 작동이 않되기 때문에 아래코드추가
		$("form[name='form_write']").on('submit',function(event){
			if($('#content').summernote('isEmpty')){
				alert('글 내용을 입력해주세요.');
				event.preventDefault();//submit전송기능을사용금지.
			}
		});
